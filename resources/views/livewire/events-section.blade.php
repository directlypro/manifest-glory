<section id="events" class="py-16 bg-white relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Worship Night -->
            <div class="bg-gradient-to-br from-amber-50 to-red-50 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Worship Night</h3>
                    <div class="flex items-center text-gray-600 mb-2">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="text-sm">Sunday, 7:00 PM</span>
                    </div>
                    ...
                    <p class="text-gray-600 text-sm">Join us for an evening of powerful worship and prayer</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-red-50 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center text-gray-600 mb-2">
                        ...
                        <span class="text-sm">Wednesday, 7:00 PM</span>
                    </div>
                    <div class="flex items-center text-gray-600 mb-4">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                        ...
                        <span class="text-sm">Ndlovu Lifestyle Apartments</span>
                    </div>
                    <p class="text-gray-600 text-sm">Deep dive into God's Word with interactive discussions</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-red-50 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-2">Combined Cell Group</h3>
                    <div class="flex items-center text-gray-600 mb-2">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="text-sm">Sunday, 6:00 PM</span>
                    </div>
                    <div class="flex items-center text-gray-600 mb-4">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                    ...
                    <p class="text-gray-600 text-sm">Fellowship, prayer, and sharing in a warm community setting</p>
                </div>
            </div>
        </div>
    </div>
