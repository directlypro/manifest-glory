<div class="min-h-screen">
    ...
    <div class="relative h-[400px] w-full">
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1642406415849-a410b5d01a94?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                 alt="Worship Service"
    ...
    <div class="py-16 px-4 bg-gradient-to-b from-slate-50 to-white">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-6xl mx-auto">
                <!-- Kennedy Mahoko Card -->
                <div class="group relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-100 shadow-lg rounded-lg p-8">
                    <div>
                        ...
                        <div class="text-center">
                            <h3 class="text-3xl font-bold text-gray-800 mb-2">Kennedy Mahoko</h3>
                ...
                <div class="group relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-100 shadow-lg rounded-lg p-8">
                    <div>
                        ...
                        <div class="text-center">
                            <h3 class="text-3xl font-bold text-gray-800 mb-2">Mrs. Lithakazi Mahoko</h3>
